...
static const char *fonts[] = {"Terminus+NerdFont:size=14"};

/* colors */
static const char dark[] = "#1d2021";
static const char grey[] = "#7c6f64";
static const char light[] = "#ebdbb2";
static const char yellow[] = "#fabd2f";
static const char green[] = "#32361a";
static const char *colors[][3] = {
    /*                  text           background      border */
    [SchemeNorm] = {light, dark, green},         // unfocused window
    [SchemeSel] = {light, dark, grey},           // focused window
    [SchemeStatus] = {light, dark, "#000000"},   // Statusbar right
    [SchemeTagsSel] = {dark, yellow, "#000000"}, // Tagbar left selected
    [SchemeTagsNorm] = {light, dark, "#000000"}, // Tagbar left unselected
    [SchemeInfoSel] = {light, green, "#000000"}, // infobar middle selected
    [SchemeInfoNorm] = {light, dark, "#000000"}, // infobar middle unselected
};

/* tagging */
static const char *tags[] = {"1 term", "2 code", "3 web", "4",     "5",
                             "6",      "7",      "8",     "9 misc"};
...
static const char *dmenucmd[] = {"rofi",  "-modi", "drun",
                                 "-show", "drun",  NULL};
static const char *swapcmd[] = {"rofi",  "-theme-str", "window {width: 30%;}",
                                "-show", "window",     NULL};
...
static Key keys[] = {
    ...
    TAGKEYS(XK_1, 0) TAGKEYS(XK_2, 1) TAGKEYS(XK_3, 2) TAGKEYS(XK_4, 3)
        TAGKEYS(XK_5, 4) TAGKEYS(XK_6, 5) TAGKEYS(XK_7, 6) TAGKEYS(XK_8, 7)
            TAGKEYS(XK_9, 8){MODKEY | ShiftMask, XK_q, spawn, {.v = powermenu}},
